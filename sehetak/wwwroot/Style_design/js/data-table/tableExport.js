            ...
            $(el).filter(function () {
              ...
              $($rows).each(function () {
                ForEachVisibleCell(this, 'td,th', $hrows.length + rowCount, $hrows.length + $rows.length,
                  function (cell) {
                    if ( typeof cell !== 'undefined' && cell !== null ) {
                      var sihtuk = $(cell).children();
                      if ( typeof sihtuk != 'undefined' && sihtuk.length > 0 )
                        collectImages(cell, sihtuk, teOptions);
                    }
                  });
                rowCount++;
              });
              ...
              if ( typeof atOptions.drawCell !== 'function' ) {
                atOptions.drawCell = function (cell, data) {
                  ...
                  if ( prepareAutoTableText(cell, data, rowopt) ) {
                    ...
                    if ( typeof rowopt != 'undefined' && typeof rowopt.sihtuk != 'undefined' && rowopt.sihtuk.length > 0 ) {
                      ...
                      drawAutotableElements(cell, rowopt.sihtuk, teOptions);
                      cell.textPos.y = y;
                      drawAutotableText(cell, rowopt.sihtuk, teOptions);
                    }
                    else
      ...
      */
      ...
      function drawAutotableElements (cell, elements, teOptions) {
        elements.each(function () {
          ...
          if ( typeof sihtuk != 'undefined' && sihtuk.length > 0 )
            drawAutotableElements(cell, sihtuk, teOptions);
        });
      }
