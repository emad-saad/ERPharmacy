...
namespace sehetak.Models
{
    public partial class Items
    {
        ...
        public string ItemcodeAlt1 { get; set; }
        public string ItemcodeAlt2 { get; set; }
        ...
        public string ItemnameScientific { get; set; }
        ...
        public short Itemslevel { get; set; }
        ...
        public string Fridgeitem { get; set; }
        public string Hasdifforigin { get; set; }
        public string Hasdiffpacks { get; set; }
        public string Itemtrans { get; set; }
        public decimal Itemsalestaxp { get; set; }
        public string Itemmedicine { get; set; }
        public string Itemstoreclassif { get; set; }
        public string ItemupdtMonthlyqty { get; set; }
        ...
        public byte Itempartno { get; set; }
        ...
        public int? Itemexpcode { get; set; }
        public string Costcentercode { get; set; }
        public byte Itemmanuf { get; set; }
        public string Itemglobalcode { get; set; }
        public int Testcode { get; set; }
        public decimal Posdiscp { get; set; }
    }
}
